...
IMAGE_ERUHI_ICON = "/images/eruhi_icon.png"
IMAGE_ERUHI_LOGO = "/images/eruhi_float.png"
IMAGE_ERUHI = "./images/eruhi_laydown.png"
...
class SizeHandler():
    def __init__(self, view, size):
        ...
        if view == UPPER_VIEW:
            ...
            self.msg_w = 410 * self.scale
            self.msg_h = 550 * self.msg_scale
            self.edit_w = self.width * 5.6 * self.scale
